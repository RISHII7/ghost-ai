    ...
    <div className="flex h-screen flex-col bg-bg-base">
      ...
      <main
        className={cn(
          ...
          sidebarOpen ? "md:pl-78" : "md:pl-3",
          aiSidebarOpen ? "md:pr-88" : "md:pr-3",
        )}
      >
        <div className="grid h-full min-h-0 gap-3">
          <section className="relative flex min-h-0 flex-1 overflow-hidden rounded-3xl border border-border-subtle bg-bg-surface">
            ...
            <div className="pointer-events-none absolute -bottom-12 -right-8 h-56 w-56 rounded-full bg-accent-ai/12 blur-3xl" />
            <div className="pointer-events-none absolute inset-0 opacity-30 bg-[linear-gradient(to_right,var(--color-border-default)_1px,transparent_1px),linear-gradient(to_bottom,var(--color-border-default)_1px,transparent_1px)] bg-size-[56px_56px]" />
      ...
      >
        <div className="flex items-center justify-between border-b border-border-default px-5 py-4">
          ...
          <Sparkles className="h-4 w-4 text-(--color-accent-ai-text)" />
        </div>
          ...
          <div className="rounded-2xl border border-border-subtle bg-bg-elevated p-4">
            <div className="mb-3 flex items-center gap-3">
              <div className="rounded-xl bg-accent-ai/14 p-2">
                <Bot className="h-4 w-4 text-(--color-accent-ai-text)" />
              </div>
              <div>
